          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              {recipe.ingredients.map((ingredient: Ingredient) => (
                <div key={ingredient.name} className="flex items-center space-x-4 p-4 rounded-lg shadow-md transition-colors duration-300 ease-in-out hover:bg-muted/50">
          ...
          <section>
            ...
            <ol className="space-y-6">
              {recipe.instructions.map((step: string, index: number) => (
                <li key={index} className="flex items-start space-x-4 p-4 rounded-lg shadow-md transition-colors duration-300 ease-in-out hover:bg-muted/50">
